...
class Wan {
  ...
  Wan.fromParams({this.errorCode, this.errorMsg, this.data});

  factory Wan(jsonStr) => jsonStr == null
      ? null
      : jsonStr is String
          ? new Wan.fromJson(json.decode(jsonStr))
          : new Wan.fromJson(jsonStr);

  Wan.fromJson(jsonRes) {
    errorCode = jsonRes['errorCode'];
    errorMsg = jsonRes['errorMsg'];
    data = jsonRes['data'] == null ? null : new Page.fromJson(jsonRes['data']);
  }
